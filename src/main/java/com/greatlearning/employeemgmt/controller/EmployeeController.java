...
public class EmployeeController {
	...
	public String saveNewEmployee(@ModelAttribute("employee") Employee emp, @PathVariable("id") int id) {
		Employee exisitingEmployee = service.getEmployeeById(id);
		exisitingEmployee.setFirstName(emp.getFirstName());
		exisitingEmployee.setLastName(emp.getLastName());
		exisitingEmployee.setEmail(emp.getEmail());
		service.saveOrUpdate(exisitingEmployee);
		return "redirect:/employees";		
	}
